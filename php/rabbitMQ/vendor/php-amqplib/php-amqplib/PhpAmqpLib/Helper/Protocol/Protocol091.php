...
class Protocol091
{
     ...
     * @return array
     */
    public function exchangeDeclare($ticket = 0, $exchange = null, $type = 'direct', $passive = false, $durable = false, $auto_delete = false, $internal = false, $nowait = false, $arguments = array())
    {
        $writer = new AMQPWriter();
     ...
     * @return array
     */
    public function exchangeDelete($ticket = 0, $exchange = null, $if_unused = false, $nowait = false)
    {
        $writer = new AMQPWriter();
        $writer->write_short($ticket);
        $writer->write_shortstr($exchange);
     ...
     * @return array
     */
    public function exchangeBind($ticket = 0, $destination = null, $source = null, $routing_key = '', $nowait = false, $arguments = array())
    {
        $writer = new AMQPWriter();
        $writer->write_short($ticket);
     ...
     * @return array
     */
    public function exchangeUnbind($ticket = 0, $destination = null, $source = null, $routing_key = '', $nowait = false, $arguments = array())
    {
        $writer = new AMQPWriter();
        $writer->write_short($ticket);
        $writer->write_shortstr($destination);
     ...
     * @return array
     */
    public function queueBind($ticket = 0, $queue = '', $exchange = null, $routing_key = '', $nowait = false, $arguments = array())
    {
        $writer = new AMQPWriter();
        $writer->write_short($ticket);
        $writer->write_shortstr($queue);
     ...
     * @return array
     */
    public function queueUnbind($ticket = 0, $queue = '', $exchange = null, $routing_key = '', $arguments = array())
    {
        $writer = new AMQPWriter();
        $writer->write_short($ticket);
        $writer->write_shortstr($queue);
